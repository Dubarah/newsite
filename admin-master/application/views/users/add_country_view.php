...
<div class="panel panel-white">
    ...
    <form method="post" enctype="multipart/form-data" action="<?php echo base_url()."add_country";?>">
    	<div class="panel-body">
            ...
            <div class="form-group <?php echo form_error('count_name_ar') ? 'has-error' : ''; ?>">
                ...
                <input type="text" value="<?php echo set_value('count_name_ar'); ?>" class="form-control" rows="10" name="count_name_ar" id="count_name_ar" placeholder="">
            </div>
        	<div class="form-group <?php echo form_error('count_name_en') ? 'has-error' : ''; ?>">
                ...
                <input type="text" value="<?php echo set_value('count_name_en'); ?>" class="form-control" rows="10" name="count_name_en" id="count_name_en" placeholder="">
            </div>
