...
<div class="panel panel-white">
    ...
    <form method="post" enctype="multipart/form-data" action="<?php echo base_url()."add_city/$country_id"; ?>">
    	<div class="panel-body">
            ...
            <div class="form-group <?php echo form_error('city_name_ar') ? 'has-error' : ''; ?>">
                ...
                <input type="text" value="<?php echo set_value('city_name_ar'); ?>" class="form-control" rows="10" name="city_name_ar" id="city_name_ar" placeholder="">
            </div>
        	<div class="form-group <?php echo form_error('city_name_en') ? 'has-error' : ''; ?>">
                ...
                <input type="text" value="<?php echo set_value('city_name_en'); ?>" class="form-control" rows="10" name="city_name_en" id="city_name_en" placeholder="">
            </div>
