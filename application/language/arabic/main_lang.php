...
$lang['add_dubarah'] 			= 'أضافة دوبارة';
$lang['categories'] 			= 'المجموعات';
$lang['category'] 				= 'المجموعة';
$lang['succ_dubarah'] 			= 'تمت اضافة دبارة بنجاح';
$lang['err_dubarah'] 			= 'هنالك مشكلة يرجى المحاولة مرة أخرى';
$lang['err_addhero'] 			= 'لديك خدمة هيرو مفعلة مسبقا';
$lang['skills'] 				= 'الخبرات';
...
$lang['short_info'] 			= 'بعض المعلومات';
$lang['country'] 				= 'الدولة';
$lang['search'] 				= 'بحث';
$lang['postedby'] 				= 'الناشر';
$lang['rgender'] 				= 'الجنس المطلوب';
$lang['services'] 				=  'الخدمات';
$lang['city'] 					= 'المدينة / المقاطعة';
$lang['languages'] 				= 'اللغات';
$lang['gender'] 				= 'الجنس';
$lang['mobile'] 				= 'الموبايل';
$lang['title'] 					= 'المسمى الوظيفي';
$lang['employer'] 				= 'الجهة الموظفة';
$lang['address'] 				= 'المدينة/العنوان';
$lang['job_type'] 				= 'نوع الفرصة';
$lang['expiration'] 			= 'مدة الانتهاء';
$lang['subcategories'] 			= 'التصنيف الفرعي';
$lang['logo'] 					= 'أضف شعار الشركة';
$lang['how'] 					= 'كيف تريد استقبال طلبات التوظيف';
$lang['both'] 					= 'الأثنان';
$lang['apply_scss'] 			= ' شكراً لك، تم تقديم طلبك بنجاح. ستقوم الجهة الموظفة بالتواصل معك قريباً في حالة كانت خبرتك مطابقة لمتطلبات الوظيفة';
$lang['owner'] 					= '  لايمكن للمالك التقديم على الوظيفة  ';
$lang['img_up'] 				= 'تم تحميل الصورة بنجاح';
$lang['deadline'] 			=  'الاعلان صالح حتى';
$lang['choose'] 				= 'أختر';
$lang['home'] 					= 'الصفحة الرئيسية';
$lang['dubarah'] 				= 'دوبارة';
$lang[''] 						= '';
$lang['full_time'] 				= 'كل الوقت';
$lang['part_time'] 				= 'وقت جزئي';
$lang['business-calltype'] 				= 'نوع الزر';
$lang['business-weblink'] 				= 'الرابط';
$lang['req_skills'] 				= 'المهارات المطلوبة ';
$lang['job_up'] 					= 'أكمل معلوماتك';
$lang['your_note'] 					=  'أكتب رسالتلك';
$lang['upload_cv'] 					=  'قم بتحميل سيرتك الذاتية';
$lang['share'] 						=  'قم بمشاركة الدبارة';
$lang['need_log'] 					= 'يجب عليك تسجيل الدخول';
$lang['logout'] 					= 'تسجيل الخروج';
$lang['need_com'] 					= 'يجب عليك أكمال معلومات حسابك';
$lang['reg_updated'] 			= 'لقد تم تحديث معلوماتك الرئيسية';
$lang['not_reg_updated'] 			= 'لم يتم تحديث ';
$lang['social_media'] 			=  'سوشل ميديا';
$lang['done_reg'] 				=  ' تم !</h1><h3> سيصلك بريد الكتروني خلال دقيقتين لتفعيل حسابك</h3> ';
$lang['jobs_section'] 			=  'اعلانات العمل';
$lang['phone_apply'] 			=  'تقدم عن طريق الهاتف';
$lang['recent_jobs'] 			=  'احدث الوظائف';
$lang['most_viewed'] 			=  'الوظائف الاكثر مشاهدة';
$lang['apply_now'] 				= 'تقدم الأن';
$lang['resume'] 				= 'السيرة الذاتية';
$lang['jobs'] 					= 'الوظائف';
$lang['description'] 			= 'وصف العمل';
$lang['male'] 					= 'ذكر';
$lang['female'] 				= 'أنثى';
$lang['freelance'] 				= 'عمل مؤقت';
$lang['contract'] 				= 'عمل بدوام كامل';
$lang['code_sent'] 				= ' تم ارسال رسالة التفعيل الى ايميلك';
$lang['mail'] 					= 'ذكر';
$lang['female'] 				= 'أنثى';
$lang['user_com'] 				= 'لقدم تم تحديث معلوماتك بنجاح';
$lang['user_not_com'] 				= 'لم يتم تحديث معلوماتك ';
$lang['user_created'] 				=  'تم إنشاء المستخدم بنجاح';
$lang['we_link'] 					=  'شبكة عالمية تعمل على ابتكار وطرح أفضل الحلول’';
$lang['refugees'] 					=  'لمشاكل';
$lang['solution'] 					=  'اللاجئين والقادمين الجدد';
$lang['welcome'] 					=  'مرحباً بك في شبكة دوبارة';
$lang['job_span'] 					=  'سيتم الغاء نشر الفرصة آلياً عند انتهاء المدة التي ستقوم بتحديدها';
$lang['any'] 						=  'لايهم';
$lang['Job_Preferences'] 			=  'تفضيلات فرصة العمل';
$lang['Who_can'] 					=  'من يستطيع التقدم للفرصة؟';
$lang['re_requirement'] 			=  'المهارات المطلوبة';
$lang['Only'] 			=  'لن يستطيع أحد التقدم لهذه الوظيفة الا اذا حقق الشروط أدناه';
$lang['phone_span'] 			=  'رقم الهاتف سيظهر للمتقدم عند الضغط على زر التقديم للوظيفة';
$lang['email_span'] 			=  'Email will not appear for applicants, we’ll send the applications directly to your inbox.';
$lang['done_dubatah'] 		=  'تم ادخال المنشور بنجاح، وهو الآن ينتظر موافقة النشر.<br/>سوف نقوم بمراجعته ونشره خلال 24 ساعة.';
$lang['thank_you'] 			=  'شكرا لك';
$lang['lastname'] 			=  'الاسم الأخير';
$lang['my_information'] 			=  'معلوماتي';
$lang['profile'] 				=  'حسابي';
$lang['my_skills'] 				=  'خبرات';
$lang['password_con'] 			=  'تأكيد كلمة المرور';
$lang['fail'] 					=  'خطأ';
$lang['success'] 				=  'تم بنجاح';
$lang['pass_changed'] 			=  'تم تعديل كلمة المرور الخاصة بك بنجاح يمكنك الآن تسجيل الدخول';
$lang['pass_not_changed'] 		=  'لم يتم تعديل كلمة المرور, يرجى المحاولة لاحقا';
$lang['token_error'] 			=  'يوجد خطأ في الكود المرسل';
$lang['complete_profile'] 		=  'يجب عليك إكمال ادخال بينات حسابك أولا حتى تستطيع التنقل في صفحتك الشخصية';
$lang['resend_code'] 			=  'إرسال كود التفعيل مرة أخرى';
$lang['code_not_resent'] 		=  'لم يتم إرسال الكود، يرجى المحاولة لاحقاً';
$lang['no_reset_mail'] 			=  'لم تقم بإدخال إيميلك ليتم ارسال الكود عليه';
$lang['code_sent_email'] 		=  'تم إرسال الكود إلى ايميلك يرجى النقر على الرابط في الايميل ليتم تغيير كلمة المرور';
$lang['code_not_sent_email'] 	=  'حدث خطأ أثناء ارسال الايميل، يرجى المحاولة لاحقاً';
$lang['forgetten'] 				=  'نسيت';
$lang['ur_pass'] 				=  'كلمة المرور الخاصة بك؟';
$lang['enter_reset_email'] 		=  'أدخل ايميلك ليتم إرسال كود التفعيل لتستطيع تغيير كلمة السر الخاصة بك';
$lang['err_user'] 				=  'الإيميل المدخل غير موجود';
$lang['send_code'] 				=  'إرسال الكود';
$lang['update_info'] 			=  'حدث معلوماتك';
$lang['needlogin'] 				=  'يجب عليك ان تسجل الدخول كي تقدم على الوظيفة';
$lang['aboutus'] 				=  'حول دوبارة ';
$lang['blog'] 					=  'المدونة';
$lang['vision'] 				=  'الرؤية والمهمة';
$lang['team'] 					=  'الفريق';
$lang['full_name'] 					=  'الأسم الكامل';
$lang['all_dubarahs'] 					=  'مجموع الدوباراة';
$lang['download_cv'] 					=  'تحميل السيرة الذانية';
$lang['user_photo'] 			= 'صورتك';
$lang['about_dubarah'] 					=  ' منظمة كندية مسجلة ضمن مقاطعة أونتاريو تعمل منذ سنة 2013 علي دمج خبرات الاجئين ومهاراتهم بمشاكل المجتمعات الـتي اتخـذوهـا كـوطـن جـديـد لـهم. تـعد دوبـارة “شـبكة تـطوع نـوعـية” بـكونـها تـقوم عـلى الاسـتفادة مـن خـبرات الـلاجـىء نـفسه وتـسخيرهـا لحـل مـشاكـل الـسوريـين والـمجتمع مـن حـولـه، والـتي بـدورهـا أثـبتت فـعالـيتها بـمساعـدة مـايـزيـد عـن 3 مـليون لاجـىء 
سوري ضمن 15 دولة، بقدرة تطوعية وصل عدد افرادها لـ 180 الف. 
';
$lang['ahmad'] 			=  '<h3 style="color:black;text-align: right;">أحمد إدلبي</h3> <br/> <p '.(LANG()=='ar' ? 'style="text-align: right;"' : '').'>
  
مؤسس شبكة دوبارة, رئيس مجلس الإدارة والرئيس التنفيذي لدوبارة, والتي قام بتأسيسها في عام 2013 
أحمد مسؤول عن تحديد التوجيهات العامة واستراتيجيات المنتجات للشركة. هو يقود تصميم خدمات دوبارة وتطوير تقنياتها الأساسية والبنية التحتية.
</p>';
$lang['majd'] 			=  '<h3 style="color:black;text-align: right;">مجد خانجي </h3> <br/><p '.(LANG()=='ar' ? 'style="text-align: right;"' : '').'> 
الشريك المؤسس لشبكة دوبارة, مدير العمليات  
مجد هو مدير العمليات في دوبارة, يشرف على العمليات التجارية الخاصة بالمؤسسة  
قبل إنضمامه لدوبارة, عمل مجد كمسؤول عن الشركات وكبار العملاء لقسم المبيعات في شركة سيريتل للإتصالات السلكية واللاسلكية  
</p>';
$lang['talin'] 			=  '<h3 style="color:black;text-align: right;">تالين كديكيان  </h3> <br/> <p style="text-align: right;">
 
مديرة خدمات شبكة دوبارة  
تقود تالين إدارة خدمات دوبارة, التصميم, وعمليات التسويق عالمياً. 
هي المسؤولة عن الخدمات والمزايا الأساسية التي تشكل التجربة الاجتماعية لمستخدمي دوبارة  شهرياً.  
انضمت تالين لدوبارة في 2013 كمنسق مهام وساهمت في بناء الإصدارات الأولية لمزايا دوبارة الأساسية, ومن ضمنها إسأل دوبرجي.  
تلى ذلك تعيين تالين كمديرة خدمات الشبكة , حيث ضبطت النمط الخاص بثقافة دوبارة وقادت تطوير مهامها, قيمها واستراتيجيات الأفراد الخاصة بها. 
تالين حاصلة على اجازة في المعلوماتية والتطبيقات الادارية من الجامعة الافتراضية السورية  
</p>';
$lang['vision_def'] 			=  'تقوم شبكة دوبارة بدعم كل مايساهم بتحقيق منفعة ايجابية وشرعية للأفراد حول العالم، لضمان حصولهم على فرص عادلة ومميزة ترفع من سوية حياتهم، من خلال منصة الكترونية توفر امكانية تقديم ومشاركة المنافع والحلول بين مستخدمين الشبكة.';
$lang['about_us'] 				=  'حول دوبارة';
$lang['quick'] 					=  'روابط مهمة';
$lang['my_profile'] 			=  'حسابي';
$lang['not_skill'] 				=  'ليست من خبراتك';
$lang['my_dubarahs'] 			=  'دوباراتي';
$lang['how_apply'] 				=  'من تقدم';
$lang['see_post'] 				=  'مشاهدة';
$lang['who_applyed'] 			=  'المتقدمين';
$lang['email_apply'] 			=  'تقدم عبر الايميل';
$lang['total_dubarah'] 			=  'عدد الناس التي تمت مساعدتهم من عام 2013 حتى الأن';
$lang['with_inf'] 				=  'بمعلوماتك ';
$lang['join'] 					=  'انضمّ إلى دوبارة';
$lang['forgot_password'] 		=  'نسيت كلمة السر';
$lang['sign_up'] 				=  'تسجيل';
$lang['login'] 					=  'تسجيل الدخول';
$lang['login_user'] 			=  'تسجيل الدخول';
$lang['create_new'] 			=  'أنشاء حساب جديد';
$lang['privacy_policy'] 			=  "الخصوصية";
//add hero trans
$lang['professional']			= 'المسمى المهني';
$lang['nationality']			= 'الجنسية';
$lang['ach_type']				= 'نوع الإنجاز';
$lang['nocker']					= 'نوكر';
$lang['ach_date']				= 'تاريخ الإنجاز';
$lang['country_of_ach']			= 'بلد الإنجاز';
$lang['city_of_ach']			= 'مدينة الإنجاز';
$lang['ach_ex']					= 'شرح الإنجاز';
$lang['socials']				= '.أحد حسابات التواصل الإجتماعي الخاصة بك مطلوبة';
$lang['suc_edit_ach']			= 'تم تعديل الإنجاز بنجاح!';
$lang['hero']					= 'المواطن البطل';
$lang['new_social_media']		= 'سوشل ميديا'; //repeated for the new design #PE$$
$lang['suc_primary']			= 'تم تحويل الإنجاز لإنجاز اساسي بنجاح!';
$lang['phone']					= 'رقم الهاتف';
$lang['about']					= 'عن نفسي';
$lang['general']				= 'عام';
$lang['profile_con']			= 'حسابي';
$lang['sec_pass']				= 'الأمان & كلمة المرور';
$lang['act']					= 'النشاط';
$lang['last_act']				= 'النشاطات الأخيرة';
$lang['cancel']					= 'إلغاء';
$lang['save']					= 'حفظ';
$lang['ab_HeroCitizen']			= 'خدمة مميزة تعمل على توثيق انجازات السوريين حول العالم، من خلال منصة تذكر فيها الانجازات و لندع العالم يقرر ماذا فعلنا!';
$lang['ab_Jobs']				= 'كانت و ما تزال، التوجه الأول لطالبين العمل حول العالم، قمنا بإضافة الكثير من التحسينات و التي تساهم بخدمة كل من طالبين و الباحثين عن العمل';
$lang['ab_Business']			= 'كانت و ما تزال، التوجه الأول لطالبين العمل حول العالم، قمنا بإضافة الكثير من التحسينات و التي تساهم بخدمة كل من طالبين و الباحثين عن العمل';
$lang['ab_Nocker']				= 'كانت و ما تزال، التوجه الأول لطالبين العمل حول العالم، قمنا بإضافة الكثير من التحسينات و التي تساهم بخدمة كل من طالبين و الباحثين عن العمل';
$lang['ab_Hub']					= 'كانت و ما تزال، التوجه الأول لطالبين العمل حول العالم، قمنا بإضافة الكثير من التحسينات و التي تساهم بخدمة كل من طالبين و الباحثين عن العمل';
$lang['ab_InfoBlog']			= 'كانت و ما تزال، التوجه الأول لطالبين العمل حول العالم، قمنا بإضافة الكثير من التحسينات و التي تساهم بخدمة كل من طالبين و الباحثين عن العمل';
$lang['ab_DubarahSolutions']	= 'كانت و ما تزال، التوجه الأول لطالبين العمل حول العالم، قمنا بإضافة الكثير من التحسينات و التي تساهم بخدمة كل من طالبين و الباحثين عن العمل';
$lang['ab_Mshmosh']				= 'كانت و ما تزال، التوجه الأول لطالبين العمل حول العالم، قمنا بإضافة الكثير من التحسينات و التي تساهم بخدمة كل من طالبين و الباحثين عن العمل';
//$lang['profile_about']					= 'عن ';
...
";
$lang['jobs'] = 'الوظائف';
$lang['termsofuse'] 			=  'شروط الأستخدام';
$lang['terms'] 					=  "© Dubarah
Terms of Use
...
30-Day Right to Opt Out: You have the right to opt out and not be bound by the arbitration and class action waiver provisions set forth above by sending (from the email address you use on Dubarah) written notice of your decision to opt out to support@Dubarah.com with the subject line, ARBITRATION AND CLASS ACTION WAIVER OPT-OUT. The notice must be sent within thirty (30) days of your first use of the Platform, otherwise you shall be bound to arbitrate disputes in accordance with the terms of those paragraphs. If you opt out of these arbitration provisions, Dubarah also will not be bound by them.
...
";
$lang['update_user'] = "تحديث";
$lang['need_login'] 	=  'عليك تسجيل الدخول لرؤية محتوى هذه الصفحة';
$lang['verify_complet'] 		= 'تم تفعيل حسابك بنجاح';


$lang['days'] 			=  ' ايام';
$lang['developers'] 			=  'المطورون';
$lang['alihajjow'] = "<h3>علي الحجو</h3> <br/> مطور ويب, ومسؤول أنظمة تشغيل. خلال مسيرته المهنية, وقد أثبت رؤيته في تطوير حلول برمجية فعالة وموثوق بها وسهلة الاستعمال، شغفه تجاه هذا المجال لم يصغر أبدا";

$lang['maherkalash'] = "<h3>ماهر كلش</h3> <br/>  قائد فريق المعلوماتية والبرمجة في دوبارة والمشرف العام على الصيانة. مطوّر ويب شغوف بالتعليم والتكنولوجيا. ";
...
$lang['you_have_achi'] 			=  'You already have achievement';
