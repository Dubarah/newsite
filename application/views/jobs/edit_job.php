...
$this->load->view('main/second/header'); ?>
 <style>
        body, html {
            height: 100%;
            margin: 0;
...
<section id="main" class="clearfix ad-details-page" style="    margin-bottom: 15px;">
    <div class="container">
        ...
        <div class="adpost-details">
            <div class="row">
                <div class="col-md-8">
                   <form method="post" enctype="multipart/form-data" action="<?php echo base_url()."edit_job/$ad_id" ?>">
                        <fieldset>
                        	<div class="header">
            <p>
                </p><h2> <strong>Edit    <?php echo trans('jobs') ?></strong>  </h2>
                              Edit information about your job below. Your job page will not appear in
                ...
                claim your business page.
                            ...
                            <div class="">
                                ...
                                <div class="row form-group brand-name">
                                    ...
                                    <div class="col-sm-7"style="margin-bottom: 30px">
                                        <input type="text" id="text"  name="title" value="<?php echo set_value('title') ? set_value('title') : $ad->title ?>" class="form-control login-form-input login-form-input-email"
                                ...
                                <div class="row form-group item-description">
                                    ...
                                    <div class="col-sm-7"style="margin-bottom: 30px;">
									  ...
									  <input type="radio" name="job_type" onclick="javascript:yesnoCheck();" value="<?php echo $type->type_id ?>" id="<?php echo $type->type_name ?>" class="custom-control-input"
									   <?php echo $ad->job_type == $type->type_id ? 'checked' : '' ?>>
                                ...
                                <div class="row form-group item-description">
                                    ...
                                    <div class="col-sm-7"style="margin-bottom: 30px;">
                                       ...
                                       <textarea id="text" name="description" rows="6" class="form-control no-border mar-top">
                                ...
                                <div class="row form-group add-image"style="margin-bottom: 30px">
                                    ...
                                    <div class="col-sm-3" style="margin-bottom: 50px" >
                                    	...
                                    	<?php $url = $ad->img? base_url().'uploads/jobslogo/'.$ad->img   : base_url().'ass/images/image_profile.jpg'   ?>
                                    	background-image: url('<?php echo $url?>')">
								<div class="hvr-profile-img">
							<input   type="file" name="fs_image1" id='getval'   class="upload w180" title="Dimensions 180 X 180" id="imag"></div>
  						<i class="fa fa-camera"></i>
  							...
  							<h4><?php echo trans('Job_Preferences') ?><span style="font-size: 12px;color: red;"> <br/><?php echo trans('Only') ?></span></h4>
                                <div class="row form-group">
                                    ...
                                    <div class="col-sm-9"style="margin-bottom: 30px; margin-top: 12px;">
                                    	 ...
                                    	 <div class="custom-control custom-radio custom-control-inline">
									  <input type="radio" name="gender"  value="3" id="any"  <?php echo $ad->gender == 3 ? 'checked' : '' ?> class="custom-control-input">
									  <label class="custom-control-label" for="any"><?php echo trans('any') ?></label>
									</div>
                                    		 <div class="custom-control custom-radio custom-control-inline">
									  <input type="radio" name="gender"  value="1"  <?php echo $ad->gender == 1 ? 'checked' : '' ?> id="male" class="custom-control-input">
									  <label class="custom-control-label" for="male"><?php echo trans('male') ?></label>
									</div> 
									<div class="custom-control custom-radio custom-control-inline">
									  <input type="radio" name="gender"  value="2"  <?php echo $ad->gender == 2 ? 'checked' : '' ?> id="female" class="custom-control-input">
                            ...
                            <div class="section seller-info">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-sm-9">
                                    <div class="custom-control custom-radio custom-control-inline">
									  <input type="radio" name="how" onclick="javascript:yesnoCheck();" value="1" id="phone" class="custom-control-input" <?php echo $ad->phone && !$ad->email ? 'checked' : '' ?>>
									  <label class="custom-control-label" for="phone"><?php echo trans('mobile') ?></label>
									</div>
									 <div class="custom-control custom-radio custom-control-inline">
									  <input type="radio" name="how" onclick="javascript:yesnoCheck();" value="2" id="email" class="custom-control-input" <?php echo !$ad->phone && $ad->email ? 'checked' : '' ?>>
									  <label class="custom-control-label" for="email"><?php echo trans('email') ?></label>
									</div>
									 <div class="custom-control custom-radio custom-control-inline">
									  <input type="radio" name="how" onclick="javascript:yesnoCheck();" value="3" id="both" class="custom-control-input" <?php echo $ad->phone && $ad->email ? 'checked' : '' ?>>
									  <label class="custom-control-label" for="both"><?php echo trans('both') ?></label>
									</div>
									 <div class="custom-control custom-radio custom-control-inline">
									  <input type="radio" name="how" onclick="javascript:yesnoCheck();" value="4" id="link" class="custom-control-input" <?php  if(!empty($ad->link)): echo 'checked'; endif; ?>>
                                ...
                                <div id="phoneyes" style="<?php echo $ad->phone?   'display:block' :  'display:none' ?>">
                                    <div class="row form-group item-description">
                                ...
                                <div id="emailyes" style="<?php echo $ad->email?   'display:block' :  'display:none' ?>">
                                    <div class="row form-group item-description">
                                ...
                                <div id="linkyes" style="<?php echo $ad->link?   'display:block' :  'display:none' ?>">
                                    <div class="row form-group item-description">
                                        ...
                                        <div class="col-sm-7" style="margin-bottom: 30px">
                                            ...
                                            value="<?php echo set_value('link') ? set_value('link') : $ad->link ?>"
                                                     style="background-image:url('<?php echo base_url()?>ass/iob.png');"
                            ...
                            <div class="checkbox section agreement">
                                ...
                                <button type="submit" id="submit" class="btn btn-secondary" style="    margin-left: 19px;
   										 margin-top: 10px;" disabled="true">Edit Your Dubarah</button>
