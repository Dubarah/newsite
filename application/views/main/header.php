...
<head>
    ...
    <!-- those following two css are for index page -->
...
<body  <?php
			echo isset($selected)?  
			 		  $selected == 'create' ||   $selected == 'edit' || $selected == 'add-job'  || $selected == 'job-view' ?  'style="background-color: #eeeeee !important;"'  : '' : ''    ?>>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content addDubarah-bigBorder">
            <div class="modal-header grey-darken-4 text-white addDubarah-bigBorder-top">
                <h2 class="modal-title text-center"><span class="red-text text-center">Add </span> Dubarah</h2>
            ...
            <div class="modal-body">
                <div class="list-group ">
                    <a href="<?php echo base_url()?>add_job" class="list-group-item list-group-item-action no-border">
                        <div class="media">
                            <img class="d-flex mr-3 add-dubarah-img" src="<?php echo base_url()?>asset/imgs/bag.svg">
                    ...
                    <a href="<?php echo base_url()?>add-achi" class="list-group-item list-group-item-action no-border">
                        <div class="media">
                            <img class="d-flex mr-3 add-dubarah-img" src="<?php echo base_url()?>asset/imgs/hero_icon.svg">
                            <div class="media-body">
                    ...
                    <a href="<?php echo base_url() ?>business-create" class="list-group-item list-group-item-action no-border">
                        <div class="media">
                            <img class="d-flex mr-3 add-dubarah-img" src="<?php echo base_url()?>asset/imgs/bus.svg">
                            <div class="media-body">
...
<div class="bgimg-1" style="<?php echo $selected == 'home'?   ''    : $selected == 'business'? "background-image: url(".base_url()."asset/imgs/refugees.jpg)" : ''    ?>">
