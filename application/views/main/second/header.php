...
<head>
    ...
    <?php if (isset($job_id)){ ?>
		...
		<meta property="og:title"       content="Dubarah -<?php echo $job->title; ?>" />
		<meta property="og:description" content='<?php /*echo $dubarah->row()->description;*/ ?>' />
		<meta property="og:image"       content="<?php echo $job->img ? base_url()."uploads/jobslogo/".$job->img : base_url().'ass/images/defult.png' ?>" />
    <?php } else {?>
    ...
    <link rel="stylesheet" href="<?php echo base_url() ?>asset/datetime/css/tempusdominus-bootstrap-4.min.css">
    <!-- <link rel="stylesheet/less" type="text/css" href="<?php echo base_url() ?>asset/datetime/glyphicons.less" /> -->    <!-- Additional CSS For Design-->
    ...
    <!-- taken from the ach_private view #PE$$ -->
    <style>
...
<body <?php
			echo isset($selected)?  
			 		  $selected == 'create' ||   $selected == 'edit'  || $selected == 'job-view' ?  'style="background-color: #eeeeee !important;"'  : '' : ''   ?>>
<div id="fb-root"></div>
<?php 
        ...
        <div class="modal-content addDubarah-bigBorder">
            ...
            <div class="modal-body">
                <div class="list-group ">
                    ...
                    <a href="<?php echo base_url()?>add-achi" class="list-group-item list-group-item-action no-border">
                        <div class="media">
                    ...
                    <a href="#" class="list-group-item list-group-item-action no-border">
                        <div class="media">
                            <img class="d-flex mr-3 add-dubarah-img" src="<?php echo base_url()?>asset/imgs/blog.svg">
                            <div class="media-body">
                                <h5 class="mt-0 font-weight-bold">Post in Dubarah</h5>
                                <p class="text-muted">
                                   We’re happy to let all Syrians arround you
                                    know about you and services you have        
                                </p>
                            </div>
                        </div>
                    </a>
                ...
                <ul class="navbar-nav mr-auto">
                  ...
                  <div class="dropdown  active">
                    ...
                    <div class="dropdown-menu" aria-labelledby="services">
                        ...
                        <a class="dropdown-item" style="color:#777" href="<?php echo base_url() ?>HeroCitizen"><?php echo 'Hero Citizen™'//trans('logout') ?></a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <div class="dropdown mar-right">
                    <button class="btn btn-icon dropdown-toggle hide-after-icon no-border" type="button" id="Notification" data-toggle="dropdown" onclick="read_nots()" aria-haspopup="true" aria-expanded="false">
                    	<img src="<?php echo base_url() ?>asset/imgs/bell.svg" /><span id="badge" class="badge badge-pill <?php echo count($new_nots) ? 'badge-danger' : 'badge-default' ?>">
                    		<?php echo  $num_row == 0 ? ''  : $num_row  ?>
                    		</span></button>
                    <div class="dropdown-menu larg-drop" aria-labelledby="Messages">
                        <h6 class="dropdown-header">Messages</h6>
                        ...
                        <?php foreach ($new_nots as $row): ?>
                            <div class="media">
                                ...
                                <div class="media-body" onclick="location.href='<?php echo base_url().$row->link?>';">
                                    <?php echo LANG() == 'en' ? '<h6 class="mt-0">'.$row->op_name_en.':</h6><p>'.$row->n_text_en.'</p>' : '<h6 class="mt-0" style="direction: rtl">'.$row->op_name.':</h6><p style="direction: rtl">'.$row->n_text.'</p>' ?>
