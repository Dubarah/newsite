    ...
    <div class="col-lg-8">
            ...
            <div class=" pad_form">
              ...
              <label> <strong> Price <i class="text-danger">*</i> </strong> </label>
               <select name="Price"   
                class="form-control">
                    <option <?php isset($pr1)? $pr1 : ''  ?> value="1">$</option>
                    <option <?php isset($pr2)? $pr1 : ''  ?> value="2">$$</option>
                    <option <?php isset($pr3)? $pr1 : ''  ?> value="3">$$$</option>
                    <option <?php isset($pr4)? $pr1 : ''  ?> value="4">$$$$</option>
                </select>
            </div>
            ...
            <div class=" pad_form">
              <label> <strong> Alcohol  </strong> </label>
               <select name="Alcohol"  
                class="form-control"  >
                <option value="0">  ---- select alcohol ---- </option>
            ...
            <?php 
           		if(isset($busin_data[0])){
            
                $c = $busin_data[0]->call_action_btn;
                $sub = ['','','','',''];
                switch ($c) {
                    case 1:
                        $sub[0]='checked';
