...
?>
 ...
 <div class="intro duOrange">
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    <img src="<?php echo base_url() ?>asset/imgs/DubarahLogoWhite.svg" class="img-fluid" style="max-width: 15rem ; margin-top: 6.5rem"><span class="text-white font-weight-bold" style="font-size: 1.5rem; vertical-align: bottom;"> Business </span>
                </div>
                <div class="col-lg-4">
