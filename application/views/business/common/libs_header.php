    ...
    <link rel="stylesheet" href="<?php echo base_url() ?>asset/datetime/bootstrap-timepicker.min.css">
    <link rel="stylesheet/less" type="text/css" href="<?php echo base_url() ?>asset/datetime/glyphicons.less" />
