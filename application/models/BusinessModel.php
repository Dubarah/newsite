...
//                 
 ...
 /// =========================== Search PAGE ============================
    ...
    public function get_busin_cities($name='')
    {
    ...
    {
        $sql  =  "select * from businesses  where name like '%".$name."%'  limit 5;";
        $b  = $this->db->query($sql)->result();
        $sql2 =  "select * from busi_catgo_parents where name like '%".$name."%' limit 5;";
        $b2  = $this->db->query($sql2)->result();
        $sql3 =  "select * from busi_catgo where name like '%".$name."%' limit 5;" ;
        $b3  = $this->db->query($sql3)->result();
        $res = [ 'business' => $b , 'cats' => $b2 , 'subCat'  => $b3  ];
        echo json_encode(  $res);
        return ;
    }
